...
-- Explanation
-- Bottleneck: The DB engine was reading all 100 rows in 'course' table
-- Method of identification: Used EXPLAIN command to check execution plan. The 'type' column showed 'ALL' on two rows
-- Resolution: Added index for column 'deptId' in table 'course'. The numer of rows read reduced to 26